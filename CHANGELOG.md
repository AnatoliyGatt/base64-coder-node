...
* Fix anonymous functions declaration coding style in base64-coder.js tests
* Fix anonymous functions declaration coding style in base64-coder.js
* Update dev dependencies
...
* Replace " with ' in definitions of all strings in base64-coder.js tests
* Replace " with ' in definitions of all strings in base64-coder.js
